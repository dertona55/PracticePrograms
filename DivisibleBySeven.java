...
public class DivisibleBySeven extends ConsoleProgram 
{
	//runs the program
	public void run() 
	{
		//Explains what the program does.
		println("This program displays the integers, between 1 and 100, that are divisible by 7.");
		
		//Determines which numbers between 1 and 100 are divisible by 7, and displays those numbers.
		for (int i = 1; i <= 100; i++) 
		{
			if (i % 7 == 0) 
			{
